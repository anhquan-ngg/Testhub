...
import { GET_DETAIL_QUESTION_ROUTE, PATCH_QUESTION_ROUTE } from '@/utils/constants';
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold">Chỉnh sửa câu hỏi</h1>
      </div>
